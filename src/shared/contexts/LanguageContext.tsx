...
const translations = {
  en: {
    ...
    // Notifications
    notif_new_booking_title: "New Parcel Booking",
    notif_new_booking_msg: "New booking from {sender} - {itemCount} item(s)",
    notif_booking_confirmed_title: "Booking Confirmed",
    notif_booking_confirmed_msg: "Your booking has been confirmed and is ready for pickup.",
    notif_parcel_delivered_title: "Parcel Delivered",
    notif_parcel_delivered_msg: "Your parcel to {receiver} has been delivered.",
    notif_parcel_returned_title: "Parcel Returned",
    notif_parcel_returned_msg: "Your parcel to {receiver} is being returned to you.",
    notif_cod_updated_title: "COD Amount Updated",
    notif_cod_updated_by_driver_msg: "COD for parcel to {receiver} updated to {amount} by driver.",
    notif_cod_updated_by_customer_msg: "COD for parcel to {receiver} updated to {amount} by customer.",
    notif_wallet_approved_title: "Wallet Request Approved",
    notif_wallet_approved_msg: "Your wallet request has been approved.",
    notif_wallet_rejected_title: "Wallet Request Rejected",
    notif_wallet_rejected_msg: "Your wallet request has been rejected.",
    notif_parcel_at_warehouse_title: "Parcel at Warehouse",
    notif_parcel_at_warehouse_msg: "Your parcel to {receiver} has arrived at the warehouse.",
    notif_delivery_assigned_title: "New Delivery Assignment",
    notif_delivery_assigned_msg: "You have been assigned a new delivery.",
    notif_pickup_assigned_title: "New Pickup Assignment",
    notif_pickup_assigned_msg: "You have been assigned a new pickup job.",
    notif_new_message_title: "New Message",
    notif_new_message_msg: "You have a new message about your parcel.",
  },
  km: {
    // General
    ...
    // Notifications
    notif_new_booking_title: "ការកក់បញ្ញើថ្មី",
    notif_new_booking_msg: "ការកក់ថ្មីពី {sender} - {itemCount} កញ្ចប់",
    notif_booking_confirmed_title: "ការកក់ត្រូវបានបញ្ជាក់",
    notif_booking_confirmed_msg: "ការកក់របស់អ្នកត្រូវបានបញ្ជាក់ហើយ រង់ចាំទទួលយក។",
    notif_parcel_delivered_title: "បញ្ញើបានដឹកជូនហើយ",
    notif_parcel_delivered_msg: "បញ្ញើរបស់អ្នកទៅ {receiver} បានដឹកជូនដោយជោគជ័យ។",
    notif_parcel_returned_title: "បញ្ញើត្រូវបានត្រឡប់",
    notif_parcel_returned_msg: "បញ្ញើរបស់អ្នកទៅ {receiver} កំពុងត្រូវបានត្រឡប់មកវិញ។",
    notif_cod_updated_title: "ចំនួន COD ត្រូវបានកែប្រែ",
    notif_cod_updated_by_driver_msg: "COD សម្រាប់បញ្ញើទៅ {receiver} កែប្រែទៅ {amount} ដោយអ្នកដឹក។",
    notif_cod_updated_by_customer_msg: "COD សម្រាប់បញ្ញើទៅ {receiver} កែប្រែទៅ {amount} ដោយអតិថិជន។",
    notif_wallet_approved_title: "សំណើកាបូបលុយត្រូវបានអនុម័ត",
    notif_wallet_approved_msg: "សំណើកាបូបលុយរបស់អ្នកត្រូវបានអនុម័ត។",
    notif_wallet_rejected_title: "សំណើកាបូបលុយត្រូវបានបដិសេធ",
    notif_wallet_rejected_msg: "សំណើកាបូបលុយរបស់អ្នកត្រូវបានបដិសេធ។",
    notif_parcel_at_warehouse_title: "បញ្ញើនៅឃ្លាំង",
    notif_parcel_at_warehouse_msg: "បញ្ញើរបស់អ្នកទៅ {receiver} បានមកដល់ឃ្លាំងហើយ។",
    notif_delivery_assigned_title: "ការងារដឹកជញ្ជូនថ្មី",
    notif_delivery_assigned_msg: "អ្នកត្រូវបានចាត់តាំងឱ្យដឹកជញ្ជូនថ្មី។",
    notif_pickup_assigned_title: "ការងារទទួលថ្មី",
    notif_pickup_assigned_msg: "អ្នកត្រូវបានចាត់តាំងឱ្យទទួលបញ្ញើថ្មី។",
    notif_new_message_title: "សារថ្មី",
    notif_new_message_msg: "អ្នកមានសារថ្មីអំពីបញ្ញើរបស់អ្នក។",
  }
};
