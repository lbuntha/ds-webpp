...
import { DriverSettlementForm } from '../../../components/staff/DriverSettlementForm';
import { useNavigate } from 'react-router-dom';

export default function StaffSettlementView() {
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Staff/Driver Settlements</h1>
