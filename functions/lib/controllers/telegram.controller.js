...
const handleWebhook = async (req, res) => {
    ...
    try {
        ...
        const text = (_a = message.text) === null || _a === void 0 ? void 0 : _a.trim();
        const fromUser = ((_b = message.from) === null || _b === void 0 ? void 0 : _b.first_name) || 'User';
        ...
        if (text.startsWith('/link')) {
            ...
            if (parts.length < 2) {
                ...
                await telegramService.sendMessage(chatId.toString(), `📋 *How to Link Your Account*\n\n` +
            ...
            if (customersSnapshot.empty) {
                await telegramService.sendMessage(chatId.toString(), `❌ *Customer not found*\n\nNo customer found with code/ID: \`${customerCode}\`\n\nPlease check your code and try again.`);
                return res.status(200).send('OK');
            }
            ...
            await telegramService.sendMessage(chatId.toString(), `✅ *Successfully Linked!*\n\n` +
        ...
        if (text === '/unlink') {
            ...
            const customersSnapshot = await admin.firestore()
                ...
                .get();
            if (customersSnapshot.empty) {
                await telegramService.sendMessage(chatId.toString(), `ℹ️ No customer account is linked to this chat.`);
                return res.status(200).send('OK');
            }
            const customerDoc = customersSnapshot.docs[0];
            const customerData = customerDoc.data();
            ...
            await telegramService.sendMessage(chatId.toString(), `✅ *Unlinked Successfully*\n\n` +
        ...
        if (text.startsWith('/start')) {
            ...
            if (parts.length >= 2) {
                ...
                if (param.startsWith('link_')) {
                    ...
                    if (!customerCode) {
                        await telegramService.sendMessage(chatId.toString(), `📋 *Link Your Account*\n\n` +
                ...
                if (userDoc.exists) {
                    ...
                    customerId = userData === null || userData === void 0 ? void 0 : userData.linkedCustomerId;
                    customerName = (userData === null || userData === void 0 ? void 0 : userData.name) || 'your account';
                    ...
                    if (customerDoc.exists) {
                        customerId = uid;
                        customerName = ((_c = customerDoc.data()) === null || _c === void 0 ? void 0 : _c.name) || 'your account';
                    }
                    else {
                ...
                if (!customerId) {
                    await telegramService.sendMessage(chatId.toString(), `❌ *Could not find your account*\n\n` +
        ...
        // ============================================
        if (text === '/help') {
            await telegramService.sendMessage(chatId.toString(), `📖 *Available Commands*\n\n` +
