...
export class FirebaseService {
    ...
    // Routes
    getRoutes() { return this.configService.getRoutes(); }
    saveRoute(route: any) { return this.configService.saveRoute(route); }
    deleteRoute(id: string) { return this.configService.deleteRoute(id); }
    seedDefaultRoutes(routes: any[]) { return this.configService.seedDefaultRoutes(routes); }
