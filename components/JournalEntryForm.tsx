...
export const JournalEntryForm: React.FC<Props> = ({ accounts, branches, currencies = [], onSubmit, onCancel, initialData }) => {
    ...
    <Card title={initialData ? "Edit Journal Entry" : "New Journal Entry"}>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end space-x-3">
          ...
          <Button type="submit" disabled={!totals.isBalanced} isLoading={loading}>
            {initialData ? 'Update Transaction' : 'Post Transaction'}
          </Button>
        </div>
      </form>
    </Card>
