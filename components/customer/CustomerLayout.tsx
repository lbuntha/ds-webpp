        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main className="flex-1 overflow-y-auto focus:outline-none bg-gray-50 p-4 sm:p-6 lg:p-8">
                <div className="max-w-6xl mx-auto">
                    {view === 'DASHBOARD' && <CustomerDashboard user={user} onNewBooking={() => handleNavigation('BOOKING')} />}
                    {view === 'PROFILE' && <CustomerProfile user={user} />}
                    {view === 'BOOKING' && <CustomerBooking user={user} onComplete={() => handleNavigation('DASHBOARD')} />}
                    {view === 'REPORTS' && <CustomerSummaryReport user={user} />}
