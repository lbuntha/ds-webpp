...
export const MenuIcon: React.FC<Props> = ({ iconKey, className = "w-5 h-5" }) => {
  switch (iconKey) {
    case 'dashboard':
    ...
    case 'banking':
      return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" /></svg>;
    case 'staff':
    ...
    case 'gift':
    case 'promo':
      return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v13m0-13V6a4 4 0 00-4-4H5.45a4 4 0 00-3.743 2.596L.312 7.404A1.5 1.5 0 001.5 9.5H8m4-3.5V6a4 4 0 014-4h2.55a4 4 0 013.743 2.596l1.395 2.808A1.5 1.5 0 0122.5 9.5H16M8 9.5h8m-8 0H8m8 0h0" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 10h16v11a1 1 0 01-1 1H5a1 1 0 01-1-1V10z" /></svg>;
    case 'jobs':
    ...
    case 'chat-delay':
      return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3" /></svg>;
    default:
